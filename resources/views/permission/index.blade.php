                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                ...
                                                <a href="{{route('permission.edit', ['id' => $value->id])}}" class="btn btn-sm btn-outline-warning mr-1">Edit</a>
                                                @endcan
                                                @can('delete permission')
                                                <a href="#" data-href="{{route('permission.destroy', ['id' => $value->id])}}" onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger">Delete</a>
                                                @endcan
                                            </td>
                                            @endcanany
                                        </tr>
