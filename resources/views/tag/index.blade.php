                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                @can('update tag')
                                                <a href="{{route('tag.edit', ['id' => $item->id])}}" class="btn btn-sm btn-outline-warning mr-1">Edit</a>
                                                @endcan
                                                @can('delete tag')
                                                <a href="#" data-href="{{route('tag.destroy', ['id' => $item->id])}}" onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger">Delete</a>
                                                @endcan
                                            </td>
                                            @endcanany
                                        </tr>
